---
title: "Schreiben: Übungen"
description: Aktive Übungen, um Schreib-Prompts gezielt zu verbessern – mit Anleitung und Reflexionsfragen.
layout: default
...
# Übungen: Schreiben mit KI

Lesen und Verstehen ist der erste Schritt. Dieser hier ist der zweite: selbst formulieren, ausprobieren, verbessern. Die Übungen bauen aufeinander auf, können aber auch einzeln gemacht werden.
...
- Verwendungszweck: Einführungstext für die Website, Besucher sollen sich für eine Demo anmelden

**Deine Aufgabe:**
1. Formuliere einen verbesserten Prompt, der diese Informationen nutzt
2. Gib ihn in KI ein und lies das Ergebnis
3. Schreibe mindestens einen Folgeprompt, der das Ergebnis gezielt verbessert
...
3. Was ist der Hintergrund (was weiß der Empfänger schon, was nicht)?
4. Welchen Ton und welches Format soll der Text haben?
...
- [ ] Habe ich den relevanten Hintergrund mitgegeben?
- [ ] Habe ich Format und Ton angegeben?
- [ ] Weiß ich, was auf keinen Fall im Text fehlen darf?

Wer alle fünf Punkte ausfüllt, bekommt selten einen generischen Entwurf.
