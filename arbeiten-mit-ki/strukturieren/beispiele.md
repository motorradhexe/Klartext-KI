---
title: "Strukturieren: Beispiele"
description: Drei Strukturierungsaufgaben mit je einem schwachen und einem starken Prompt.
layout: default
...
# Beispiele: Vorher / Nachher für verschiedene Strukturierungsaufgaben

Drei häufige Situationen, in denen KI beim Strukturieren hilft – von der Schulungsplanung bis zur Entscheidungsvorbereitung.

---

## Beispiel 1: Schulung planen
...
- Zielgruppe: kein IT-Hintergrund, 15 Personen
- Lernziel: drei konkrete Punkte
- Zeitrahmen: 90 Minuten
- Format-Wunsch: Vortrag vs. interaktiv unterscheiden

**Wie der Dialog weitergeführt werden kann:**
- „Der interaktive Teil klingt gut. Gib mir für den ‚Was darf ich nicht?'-Abschnitt drei konkrete Fallbeispiele aus dem Alltag einer Marketingabteilung."
- „Die Gliederung ist zu dicht für 90 Minuten. Welche zwei Punkte würdest du kürzen oder zusammenfassen?"

---

## Beispiel 2: Eine Entscheidung vorbereiten
...
- Hintergrund der Person: nicht technisch
- Klarer Auftrag: keine Empfehlung, sondern Kriterien
- Zusatzbitte: markieren, was externe Expertise braucht

Das Modell gibt keine Antwort auf die Frage, welche Option besser ist. Es strukturiert die Grundlage für die eigene Entscheidung.

**Wie der Dialog weitergeführt werden kann:**
- „Ich verstehe das Kriterium ‚Datenresidenz' nicht. Was bedeutet das konkret für unsere Situation?"
- „Welche dieser Kriterien sind voneinander abhängig – also wo beeinflusst ein Punkt die anderen?"

---

## Beispiel 3: Ideen für ein Dokument ordnen
...
- Zweck des Dokuments: Entscheidungsvorlage
- Zielgruppe: Geschäftsführung, Entscheidungsträger
- Umfangsbegrenzung: maximal fünf Abschnitte

Das Modell sortiert die Punkte nicht nur – es ordnet sie so, dass sie die Logik einer Entscheidungsvorlage unterstützen.

**Wie der Dialog weitergeführt werden kann:**
- „Den Abschnitt Kosten würde ich lieber nach hinten verschieben – macht das Sinn?"
- „Fehlt etwas für eine vollständige Entscheidungsvorlage?"
