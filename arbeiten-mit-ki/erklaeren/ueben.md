---
title: "Erklären: Übungen"
description: Aktive Übungen, um Erklärungs-Prompts zu schärfen und Erklärungen auf Zielgruppen anzupassen.
layout: default
...
# Übungen: Erklären mit KI

Eine Erklärung ist erst gut, wenn die andere Person sie versteht – nicht wenn sie für den Erklärenden klingt wie für ihn selbst. Diese Übungen trainieren genau das.
...
**Aufgabe:** Lass KI eine Erklärung eines Konzepts für eine bestimmte Person formulieren. Dann überprüfe die Erklärung – nicht ob sie richtig klingt, sondern ob sie wirkt.

**Ablauf:**
1. Formuliere den Erklärungs-Prompt mit Zielgruppe, Ziel und Format.
2. Lies das Ergebnis. Dann frage KI: „Was würde diese Person nach dem Lesen noch nicht verstanden haben – und welche Frage würde sie stellen?"
3. Passe die Erklärung basierend auf dieser Einschätzung an.
...
- [ ] Habe ich den Inhalt fachlich geprüft – nicht nur ob er gut klingt?
- [ ] Passt die Sprache zu der Person, die den Text liest?
- [ ] Ist die Analogie (falls vorhanden) für diese Zielgruppe treffend?
