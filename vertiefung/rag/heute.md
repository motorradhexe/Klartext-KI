...
**Langes [Kontextfenster](../../glossar#kontextfenster):** Wenn die gesamte relevante Information in einen einzigen Kontext passt, kann man einfach alles einfügen. Für ein einzelnes Handbuch von 50 Seiten braucht es kein RAG – das Dokument passt direkt in den Kontext moderner Modelle. RAG lohnt sich erst, wenn die Datenmenge das Kontextfenster sprengt oder die Auswahl relevanter Abschnitte selbst eine Aufgabe ist.
