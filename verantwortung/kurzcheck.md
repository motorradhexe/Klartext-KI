---
title: Kurzcheck vor dem KI-Einsatz
description: Fünf Fragen, die man einmal durchdenken sollte, bevor man KI produktiv in einem neuen Kontext einsetzt.
layout: default
...
## Frage 2: Erlaubt das meine Organisation?
...
→ Mehr dazu: [Grenzen und Regeln](grenzen-und-regeln)
...
→ Mehr dazu: [Verlässlichkeit von KI-Ausgaben](verlaesslichkeit)

---

## Frage 4: Muss ich offenlegen, dass KI beteiligt war?

In vielen Alltagssituationen: Nein. Es gibt keine universelle Kennzeichnungspflicht für KI-unterstützte Texte im beruflichen Alltag.

Aber: Es gibt Kontexte, in denen eine Offenlegung erwartet wird – Wissenschaft, Journalismus, bestimmte regulierte Bereiche –, und es gibt Situationen, in denen es einfach redlich ist: Wenn jemand annimmt, dass ein Text vollständig von einer Person stammt, und das für seine Einschätzung relevant ist.

Die praktische Frage: Würde die Person, die diesen Text liest, es als relevant betrachten zu wissen, dass KI beteiligt war? Wenn ja, sagen.

→ Mehr dazu: [Grenzen und Regeln](grenzen-und-regeln)

---

## Frage 5: Behalte ich mein eigenes Urteil?
...
## Schnellübersicht: Was unkritisch ist, was Klärung braucht

| Situation | Einschätzung |
|-----------|-------------|
| Eigene Textentwürfe, allgemeine Fachfragen | Unkritisch |
| Sprachverbesserung eigener Texte ohne Vertraulichkeitsanspruch | Unkritisch |
| Interne Dokumentation mit betrieblichem Know-how | Klärung empfohlen |
| Kundenkommunikation, Berichte nach außen | Inhalt prüfen, keine KI-Ausgaben ungeprüft weitergeben |
| Personenbezogene Daten Dritter | Nur mit Klärung der DSGVO-Situation |
| Code mit API-Keys oder Zugangsdaten | Stop – erst ersetzen, dann eingeben |
| Vertragsinhalte mit Vertraulichkeitsklauseln | Klärung der Unternehmensrichtlinie erforderlich |
| Patientendaten, Mandantendaten, Finanzkundendaten | In der Regel nicht ohne besonderen Vertrag |
| Passwörter, Secrets, Credentials | Niemals |
